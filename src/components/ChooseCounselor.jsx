...
export default function ChooseCounselor({ isMobileMenuOpen, onMobileMenuClose }) {
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-purple-600 via-purple-700 to-pink-600 text-white py-12 w-full">
          ...
          <div className="relative w-full px-6">
            <div className="max-w-6xl mx-auto text-center">
              <h1 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-white to-pink-200 bg-clip-text text-transparent">
                Choose Your Counselor
              </h1>
              <p className="text-lg text-purple-100 max-w-3xl mx-auto">
                Select an experienced counselor to guide your academic journey
              </p>
            </div>
          </div>
        </section>
      ...
      <div className="w-full">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-purple-600 via-purple-700 to-pink-600 text-white py-12 w-full">
          ...
          <div className="relative w-full px-6">
            <div className="max-w-6xl mx-auto text-center">
              <h1 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-white to-pink-200 bg-clip-text text-transparent">
                Your Counselor Request
              </h1>
              <p className="text-lg text-purple-100 max-w-3xl mx-auto">
                Your counselor selection status
              </p>
            </div>
          </div>
        </section>
