  ...
  const loadStudentsFromDB = async () => {
    try {
      ...
      if (studentsResult.success && studentsResult.data) {
        // Filter for students only and format the data
        const studentUsers = studentsResult.data
          ...
          .map(student => ({
            ...
            targetUniversities: student.target_universities ? student.target_universities.split(',') : ['Not specified'],
            gpa: student.gpa || 'Not provided',
            englishScore: student.english_score || 'Not provided',
            workflow: {
              counseling: { completed: student.counseling_completed || false, completedAt: student.counseling_date },
              universitySelection: { completed: student.university_selection_completed || false, completedAt: student.university_selection_date },
